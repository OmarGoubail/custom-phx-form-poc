defmodule FormxWeb.UserLiveTest do
  use FormxWeb.ConnCase

  import Phoenix.LiveViewTest
  import Formx.AccountsFixtures

  @create_attrs %{name: "some name", nickname: "some nickname"}
  @update_attrs %{name: "some updated name", nickname: "some updated nickname"}
  @invalid_attrs %{name: nil, nickname: nil}
